...
extraVolumes:
  - name: synctree
    hostPath:
      path: /var/log/synctree/logs-group/runtime-log

# Extra volume mounts together. Corresponds to `extraVolumes`.
extraVolumeMounts:
  - name: synctree
    mountPath: /var/log/synctree/logs-group/runtime-log
    readOnly: true
...
#          {{- end }}
  ...
  file: |
    ...
    scrape_configs:
      ...
      - job_name: synctree-api-logs
        static_configs:
        - labels:
           job: synctree-api-logs
           __path__: /var/log/synctree/logs-group/runtime-log/proxy.log
        pipeline_stages:
          - json:
              expressions:
      ...
      - job_name: synctree-app-logs
        static_configs:
        - labels:
           job: synctree-app-logs
           __path__: /var/log/synctree/logs-group/runtime-log/synctree.log
      - job_name: synctree-console-logs
        static_configs:
        - labels:
           job: synctree-console-logs
           __path__: /var/log/synctree/logs-group/runtime-log/console.log
